...
HTML/JS 기반 10페이지 인터랙티브 교육 사이트입니다.  
...
상단 **앱 설치 / Install app** 버튼으로 홈 화면·데스크톱에 설치할 수 있습니다.

- `manifest.webmanifest` + `sw.js` + `assets/icons/`
- Chrome/Edge: 설치 프롬프트 또는 주소창 설치 아이콘
- iOS Safari: 공유 → 홈 화면에 추가 (자동 프롬프트 대신 안내 표시)
